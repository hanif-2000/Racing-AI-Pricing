...
export const API = {
  // Main
  aiPrices: (country = 'ALL', margin = 1.30) => 
  ...
  deleteTracker: (meeting) => `${API_BASE_URL}/api/live-tracker/${meeting}/delete/`,
...
export const DEFAULT_MARGIN = 1.30; // 130%
export const MIN_MARGIN = 1.00;     // 100%
export const MAX_MARGIN = 1.50;     // 150%
